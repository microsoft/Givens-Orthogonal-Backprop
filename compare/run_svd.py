...
t0 = time.time()
print("Compiling fastH c++/cuda code, this usually takes 1-2 min. ")
path = "/home/cangoksen14/funStuff/fasth"
algo = load(name="fasth", sources=[ path +"/fasth.cpp", path + "/fasth_cuda.cu"])
